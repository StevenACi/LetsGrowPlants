...
#"""
 #def dispersion(self):
  #if self.energyS.chlorophyl > 5:
  # self.energyS.pullChlorophyl(5)

 # if self.energyS.chlorophyl > 0.5:
  # self.energyS.pullChlorophyl(0.5)
#"""
